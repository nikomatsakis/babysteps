...
this idea, although I think it somewhat unlikely that we will
integrate this idea into Rust at this point (though the change could
be done in a fairly backwards-compatible way, I think).
...
I think we can have our cake and eat it too. If we're going to make
this change, of course, now's the time to do it! I think that's pretty
exciting, since the non-composability of vector types is one of the
more visible language warts that tends to trip up newcomers.
