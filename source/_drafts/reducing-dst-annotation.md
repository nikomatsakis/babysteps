...
smart pointerswork out more smoothly with DST, since it means that one
...
for smoother integration with deriving and also for destructors).  To
see what I mean, consider `Opt
